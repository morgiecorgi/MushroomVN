...
image FogpartS = SnowBlossom("./images/resources/fogs.png", count=75, border=768, xspeed=35, yspeed=0, start=5, fast=True, horizontal=True)
image FogpartL = SnowBlossom("./images/resources/fog.png", count=75, border=768, xspeed=35, yspeed=0, start=5, fast=True, horizontal=True)
...
# Declare transitions
define slowopen = Fade(0,2.0,0.5)

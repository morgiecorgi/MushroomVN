...
init -1 python hide:
    ...
    config.window_title = u"Mushrooms"
    ...
    style.window.background = Frame("./images/menu/dbackg.png", 25, 25)
    ...
    style.default.font = "./etc/terminus.ttf"
...
python early:
    config.save_directory = "Mushrooms-1434527056"
